...
# -*- coding: utf-8 -*-
"""
Title: Detect function for inference
@author: @author: Giacomo Nodjoumi g.nodjoumi@jacobs-unversity.de
EDITED FROM: https://github.com/ultralytics/yolov5


Created on Wed Dec  2 17:06:14 2020
@author: @author: Giacomo Nodjoumi g.nodjoumi@jacobs-unversity.de
"""
...
def detect(args_dict,save_img=False):
    ...
    save_txt = args_dict['save_txt']
    update = args_dict['update']
    classes = args_dict['classes']
    augment = args_dict['augment']
    agnostic_nms = args_dict['agnostic_nms']
    view_img = args_dict['view_img']

    # Initialize
    set_logging()
    device = select_device(args_dict['device'])
